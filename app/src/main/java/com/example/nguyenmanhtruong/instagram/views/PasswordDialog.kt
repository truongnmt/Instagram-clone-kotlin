package com.example.nguyenmanhtruong.instagram.views
...
import kotlinx.android.synthetic.main.diaglog_password.view.*
...
class PasswordDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val view = activity!!.layoutInflater.inflate(R.layout.diaglog_password, null)
